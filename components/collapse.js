...
export default function CollapseCard({
    ...
    return(
        <Box key={key} initial={{ height: 'fit-content' }} animate={{ height: state === index ? 'fit-content' : '85px', transition:{ delay: 0.2 } }} transition={{ duration: 0.3 }} width="100%" bgColor="#27274C" borderRadius="20px" margin="10px 0px" padding="20px" flexDir="column">

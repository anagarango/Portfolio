...
import { Box, Hero, Container, Heading, Text, CTA } from '@/components/globals'
        ...
        <Footer/>
          <Hero id="Home" className="hero" minHeight="100vh" bgPosition="bottom left" src='/Landing.svg' bgRepeat="no-repeat" bgSize="cover" flexDir="row" padding="0px 150px" justCont="center" aliIt="center" priority>
            ...
            <Box className="heroCont" width="50%">
              <Image alt="gif of Ana Arango making faces" src="/Hero.gif" width={150} height={100} style={{width:"100%", height:"fit-content"}} priority></Image>
            </Box>
          </Hero>
          ...
          <Container id="About" flexDir="column" width="100%" padding="10px 150px" aliIt="flex-end">
            ...
            <Box display="inline" width="100%">
                <Image className='aboutmeimage' src="/aboutme.png" alt="Eagle eye shot of Ana Arango working on her desktop and laptop" width={200} height={200} style={{width:"40%", height:"100%", float:"left", margin:"0px 30px 30px 50px", minWidth:"350px"}} priority/>
          ...
          <Container id="Experience" flexDir="column" width="100%" padding="0px 150px 100px 150px">
